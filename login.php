            ...
            if (!isset($_SESSION['user_id'])) {
                if (isset($_POST['submit'])) {
                    ...
                    if (!empty($user_username) && !empty($user_password)) {
                        // Look up the username and password in the database without hashing the password
                        $query = "SELECT user_id, username FROM member WHERE username = '$user_username' AND password = '$user_password'";
